...
function getProjectPath() {
    ...
    //pathName.substr(1) ： 截取cloudlibrary/admin/books.jsp 
    //"cloudlibrary/admin/books.jsp ".indexOf('/') :返回 12
    //substring(from ,to)： from 必选，to 可选
    //pathName.substring(0, 12 + 1); --> /cloudlibrary
